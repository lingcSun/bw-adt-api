...
const T = {
  ...
  "dtp.ts": [
    ...
    ["executeDTP", "W", "POST /sap/bw/modeling/dtpa/executerun", "触发执行（201+Location 返回 runId；2026-09-21 抓包实证）"],
    ["getDTPExecuteRunResult", "R", "GET /sap/bw/modeling/dtpa/executerun/{id}/{runId}?withLog=true", "执行状态轮询（2026-09-21 抓包实证）"],
...
const CLIENT_EXCEPTIONS = {
  ...
  getDTPExecuteRunResult: ["R", "= getDTPExecuteRunResult", "DTP 执行状态轮询"],
